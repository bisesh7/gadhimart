...
// @route   GET /api/motorcycleChatSessions/
// @desc    Get all the motorcycle chat sessions
// @access  ADMIN
router.get("/", (req, res) => {
  ...
  const getData = (documents) => {
    ...
    const pushToData = (document) => {
      data.push({
        ...
        usersInvolved: document.usersInvolved,
        date: document.date,
      });
    };
...
// @route   GET /api/motorcycleChatSessions/:id
// @desc    Get a motorcycle chat session wih given id
// @access  ADMIN
...
// @route   DELETE /api/motorcycleChatSessions?query
// @desc    Delete motorycle chat sessions in query
// @access  ADMIN
router.delete("/", (req, res) => {
  ...
  if (typeof req.query.filter !== "undefined") {
    ...
    ChatSession.find({ vehicleType: "Motorcycle" })
      .where("_id")
      .in(id)
      .exec((err, documents) => {
        if (err) {
