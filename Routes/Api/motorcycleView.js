...
// @route   GET /api/motorcycleViews/
// @desc    Get all the motorcycleViews
// @access  ADMIN
router.get("/", (req, res) => {
  ...
  //   Only search for the Motorcycles
...
// @route   GET /api/motorcycleViews/:id
// @desc    Get motorcycleViews wih given id
// @access  ADMIN
