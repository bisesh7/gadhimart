...
// @route   GET /api/forgotPasswords/
// @desc    Get all the forgot passwords
// @access  ADMIN
router.get("/", (req, res) => {
  ...
  ForgotPassword.find(filterDetail)
...
// @route   GET /api/forgotPasswords/:id
// @desc    Get a forgot password wih given id
// @access  ADMIN
...
// @route   DELETE /api/forgotPasswords/:id
// @desc    Delete forgot password with given id
// @access  ADMIN
router.delete("/:id", (req, res) => {
  ...
  ForgotPassword.findOne({ _id: id }).then((document) => {
    if (!document) {
      return res.status(400).json({
        success: false,
        err: "noEmailError",
...
// @route   DELETE /api/forgotPasswords?query
// @desc    Delete forgot passwords in query
// @access  ADMIN
