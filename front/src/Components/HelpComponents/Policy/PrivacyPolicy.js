...
const PrivacyPolicy = (props) => {
  return (
    <Fragment>
      <h1>Privacy Policy for Gadhimart</h1>

      <p>
        At Gadhimart, accessible from www.gadhimart.com, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by
        Gadhimart and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Gadhimart. This policy is not applicable to any
      ...
      <p>
        Gadhimart follows a standard procedure of using log files. These files
      ...
      <p>
        Like any other website, Gadhimart uses 'cookies'. These cookies are used
      ...
      <p>
        ...
        advertising partners of Gadhimart.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Gadhimart, which are sent
      ...
      <p>
        Note that Gadhimart has no access to or control over these cookies that
      ...
      <p>
        Gadhimart's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        Gadhimart does not knowingly collect any Personal Identifiable
