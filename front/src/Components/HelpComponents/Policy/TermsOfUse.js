...
const TermsOfUse = () => {
  return (
    <Fragment>
      ...
      <p>Welcome to Gadhimart!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Gadhimart's Website, located at www.gadhimart.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Gadhimart if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing Gadhimart, you agreed to use
        cookies in agreement with the Gadhimart's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Gadhimart and/or its licensors own the
        intellectual property rights for all material on Gadhimart. All
        intellectual property rights are reserved. You may access this from
        Gadhimart for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Gadhimart</li>
        <li>Sell, rent or sub-license material from Gadhimart</li>
        <li>Reproduce, duplicate or copy material from Gadhimart</li>
        <li>Redistribute content from Gadhimart</li>
      </ul>

      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        Gadhimart does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Gadhimart,its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, Gadhimart shall not be liable
      ...
      <p>
        Gadhimart reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Gadhimart a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Gadhimart; and (d) the link is
      ...
      <p>
        ...
        e-mail to Gadhimart. Please include your name, your organization name,
      ...
      <p>
        No use of Gadhimart's logo or other artwork will be allowed for linking
